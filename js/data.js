/**
 * Messi Career Data - The comprehensive data source for the GOAT's statistics
 * This file contains all career stats, moments, timeline, trophies, and quotes.
 * Updated periodically via the stats-updater module.
 */
...
const MESSI_DATA = {
  ...
  moments: [
    ...
    },
    {
      ...
      description:
        "In 2012, Messi shattered Gerd M\u00fcller's 40-year-old record by scoring 91 goals in a single calendar year. A feat that may never be matched.",
      year: "2012",
      emoji: "\uD83D\uDD25",
    },
    {
      ...
      description:
        "After decades of heartbreak, Messi finally won a senior international trophy, leading Argentina to Copa Am\u00e9rica glory at the Maracan\u00e3 against Brazil.",
      year: "2021",
      emoji: "\uD83C\uDDE6\uD83C\uDDF7",
    },
    {
      ...
      description:
        "A 19-year-old Messi announced himself on the biggest stage with a hat-trick against Real Madrid at the Bernab\u00e9u in a 6-2 demolition.",
      year: "2009",
      emoji: "\u26BD",
    },
    {
      ...
      description:
        "Picking up the ball in his own half, Messi dribbled past 6 players and the goalkeeper in a goal that mirrored Maradona's famous World Cup strike. Poetry in motion.",
      year: "2007",
      emoji: "\uD83C\uDF1F",
    },
    {
      title: "Champions League Masterclass vs Bayern",
      description:
        "Two goals including one where he nutmegged Boateng so badly the defender fell to the ground. Messi at his devastating, untouchable best.",
      year: "2015",
      emoji: "\uD83D\uDCA5",
    },
    {
      title: "UCL Final vs Manchester United",
      description:
        "A towering header over Rio Ferdinand sealed Barcelona's dominance in the 2009 Champions League Final. The goal that crowned the greatest team performance.",
      year: "2009",
      emoji: "\uD83C\uDF1F",
    },
    {
    ...
    {
      title: "Finalissima - Italy Demolition",
      description:
        "Argentina crushed European champions Italy 3-0 at Wembley with Messi putting on a mesmerizing display of passing and vision.",
      year: "2022",
      emoji: "\uD83C\uDDEE\uD83C\uDDF9",
    },
  ],
  ...
  timeline: [
    ...
    },
    {
      ...
      text: "Scores his first La Liga goal at 17 years and 10 months, becoming the youngest scorer in club history at the time.",
    },
    {
      year: "2009",
      title: "First Ballon d'Or & Champions League",
      text: "Wins his first Ballon d'Or and scores in the Champions League Final. The start of an era of complete dominance.",
    },
    {
      year: "2012",
    ...
    },
    {
      ...
      text: "Alongside Su\u00e1rez and Neymar, leads Barcelona to the treble. Widely regarded as the best season of the best front three ever.",
    },
    {
      year: "2021",
    ...
    },
    {
      ...
      text: "Joins Inter Miami, wins Leagues Cup immediately. Claims an unprecedented 8th Ballon d'Or. The legend only grows.",
    },
    {
      year: "2024",
  ...
  trophies: [
    ...
    { name: "European Golden Shoe", count: 6, icon: "\uD83D\uDC5F", years: "2010, 2012, 2013, 2017, 2018, 2019" },
